  ...
  public function destroy(Assignment $assignment)
  {
   ...
   public function showSlip($assignmentID, $slipID){
      ...
      try {
        ...
        $assignmentID = Hashids::decode($assignmentID)[0];
        $slipID  = Hashids::decode($slipID)[0];

      } catch (\Exception $e) {
        $message = 'There is something wrong with this URL... Please contact the system administrator.';
